 ...
 * 
 */
public abstract class MyBaseCommand {
    public final String tooltip;
    public final String errorMessage;
    public final int    minParam;
    public final int    maxParam;

    public MyBaseCommand(String tooltip) {
        this(tooltip, "Undefined", 0);
    }

    public MyBaseCommand(String tooltip, String errorMessage, int minParam) {
        this(tooltip, errorMessage, minParam, 0);
    }

    public MyBaseCommand(String tooltip, String errorMessage, int minParam, int maxParam) {
